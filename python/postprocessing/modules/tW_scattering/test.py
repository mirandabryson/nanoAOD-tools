...
p = PostProcessor('./', ['/hadoop/cms/store/user/dspitzba/tW_scattering/tW_scattering/nanoAOD/tW_scattering_nanoAOD_500.root'], cut=cut, modules=modules, fwkJobReport=True,\
